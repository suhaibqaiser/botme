...
exports.findReservation = exports.editReservation = exports.addReservation = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.createReservation(reservation)];
                case 1:
                    result = _a.sent();
                    if (result) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.updateReservation(reservation)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.getReservation(reservationId)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
