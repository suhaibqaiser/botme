...
exports.updateCustomer = exports.createCustomer = exports.findCustomer = void 0;
var response_1 = require("../../utils/response");
var service_1 = require("./service");
function findCustomer(filter) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.getCustomer(queryParams)];
                case 1:
                    result = _a.sent();
                    if (result) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.addCustomer(customer)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.updateOneCustomer(customer)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
