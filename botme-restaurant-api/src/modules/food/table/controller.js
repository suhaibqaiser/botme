...
exports.addTable = exports.updateOneTable = exports.getAllTable = exports.findTable = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    queryParams = { tableSeats: undefined, tableOccupied: undefined, area: undefined };
                    if (filter.seats) {
                    ...
                    return [4 /*yield*/, service_1.getTable(queryParams)];
                case 1:
                    result = _a.sent();
                    if (result.length != 0) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    response = new response_1.restResponse();
                    return [4 /*yield*/, service_1.getAllTables()];
                case 1:
                    result = _a.sent();
                    if (result.length != 0) {
                        response.payload = result;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.updateTable(table)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.createTable(table)];
                case 1:
                    result = _a.sent();
                    if (result) {
                        response.payload = result;
