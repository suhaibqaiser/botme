...
exports.findProduct = exports.addProduct = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, service_1.createProduct(product)];
                case 1:
                    result = _a.sent();
                    if (result) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    response = new response_1.restResponse();
                    queryParams = { productName: undefined, productPrice: undefined, category: undefined };
                    ...
                    return [4 /*yield*/, service_1.getProduct(queryParams)];
                case 1:
                    result = _a.sent();
                    if (result.length != 0) {
                        response.payload = result;
