...
#login button
button = Button(login,text="Login",font=text_font,command=lambda: checkForClient(clientID.get(),clientSecret.get(),clientDeviceId.get()))
...
# Bot Image
label = tk.Label(main, font=text_font, image=imageNeutral,width=455,height=300)
